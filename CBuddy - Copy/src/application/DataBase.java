...
public class DataBase extends Details{
	...
	public void updateprofile(String pass,String email,String addr,String phn,String id) throws SQLException {		//Update user information
		st.executeUpdate("UPDATE `buddies` SET `Password` = '"+pass+"', `Phone` = '"+phn+"', `Email` = '"+email+"',`Address` = '"+addr+"' WHERE `buddies`.`ID` = '"+id+"';");
		alt.setTitle("Congratulations");
